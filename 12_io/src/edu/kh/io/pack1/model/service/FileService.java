...
public class FileService {
	...
	// - 경로 표기 방법
	// 1) 절대 경로 : 하나의(절대적인) 기준으로부터 찾고자하는 목표까지의 경로를 모두 표기하는 방법
	// - 기준
	// [Windows] 	:	C:/		or	D:/
	// [Linux, Mac] : 	/Users	or	/
	...
	public void method3() {
		...
		// 지정된 디렉토리에 있는 모든 파일/디텔토리를 File[] 형태로 얻어오기
...
//			System.out.println(date);
			...
			String result = String.format("%-20s %-20s %-5s %10s", f.getName(), date, type, size);
